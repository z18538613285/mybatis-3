...
public final class TypeHandlerRegistry {
   ...
   * Date 对应了多个 JDBC 的 TypeHandler 的注册。
   *
   * 当一个 Java Type 不存在对应的 JDBC Type 时，就使用 NULL_TYPE_HANDLER_MAP 静态属性，
   * 添加到 TYPE_HANDLER_MAP 中进行占位。
   *
   ...
   * 答案在 #getTypeHandler(Type type, JdbcType jdbcType) 方法
   *
   *
   */
  ...
  // 未使用 @MappedTypes 注解 注册 TypeHandler 对象。
  @SuppressWarnings("unchecked")
